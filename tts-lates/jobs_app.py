...
# --- Run via: uvicorn jobs_app1_fastapi:app --host 0.0.0.0 --port 5003 ---
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(
        "jobs_app1_fastapi:app",   # tên module của bạn
        host="0.0.0.0",
        port=5003,
        # workers=1,               # bỏ nếu gặp OOM khi spawn nhiều workers
        log_level="info",
        reload=True                # chỉ dev, reload khi code thay đổi
    )
